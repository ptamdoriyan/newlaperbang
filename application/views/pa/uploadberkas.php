...
<div class="row mt-2">
	<div class="col">
		...
		<div class="accordion" id="accordionExample">
			...
			<!-- upload Tanda Terima Putusan -->
			<div class="accordion-item">
				<h2 class="accordion-header" id="headingFour">
					<button class="accordion-button collapsed bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#tandaterima" aria-expanded="false" aria-controls="collapseFour">
						Upload Tanda Terima Putusan
					</button>
				</h2>
				<div id="tandaterima" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
					<div class="accordion-body">
						<form method="post" action="<?= base_url('pa/banding/tandaterimaupload'); ?>" enctype="multipart/form-data">
							<div class="row">
								<input type="text" value="<?= $perkara[0]['id_perkara'] ?>" hidden name="id_perkara"></input>

								<label for="formFileSm" class="col-2 form-label">Tanggal Tanda Terima</label>
								<div class="col-4">
									<input class="form-control form-control-sm" type="date" name="tgltrima">
								</div>
								<div class="col-4">
									<input class="form-control form-control-sm" type="file" accept="application/pdf" name="file_tt">
									<small class="text-satu fw-lighter">*File PDF Size Maksimal 10 mb</small>
								</div>
								<div class="col-2 text-success <?= $perkara['0']['tanda_terima_putusan'] ? '' : 'd-none' ?> ">
									<span class="text-satu"> <i class="fas fa-paperclip"></i></span>
									<a href="<?= base_url('files/tanda_terima/') . $perkara['0']['tanda_terima_putusan'] ?>" class="text-decoration-none text-reset" target="_blank">
										<?= $perkara['0']['tanda_terima_putusan'] ?>
									</a>
