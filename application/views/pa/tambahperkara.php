				...
				<div class="container mt-3">
					...
					<form method="post" action="<?= base_url('pa/banding/tambahperkara'); ?>" enctype="multipart/form-data">
						...
						switch ($this->session->userdata('kode_pa')) {
							case 'PA.Mdo':
								$kode_surat_pa = 'PAN.W18-A1';
								break;
							case 'PA.Ktg':
								$kode_surat_pa = 'PAN.W18-A2';
								break;
							case 'PA.Thn':
								$kode_surat_pa = 'PAN.W18-A3';
								break;
							case 'PA.Tdo':
								$kode_surat_pa = 'PAN.W18-A4';
								break;
							case 'PA.Btg':
								$kode_surat_pa = 'PAN.W18-A5';
								break;
							case 'PA.Amg':
								$kode_surat_pa = 'PAN.W18-A6';
								break;
							case 'PA.Llk':
								$kode_surat_pa = 'PAN.W18-A7';
								break;
							case 'PA.Blu':
								$kode_surat_pa = 'PAN.W18-A8';
								break;
							case 'PA.Brk':
								$kode_surat_pa = 'PAN.W18-A9';
								break;
							case 'PA.Tty':
								$kode_surat_pa = 'PAN.W18-A10';
								break;
							case 'PA.Per':
								$kode_surat_pa = 'PAN.W18-A11';
								break;
						}
